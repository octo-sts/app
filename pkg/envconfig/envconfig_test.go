...
func TestBaseConfig(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Sticky store URL set is valid",
			envVars: map[string]string{
				"PORT":                     "8080",
				"GITHUB_APP_IDS":           "12345678",
				"OCTOSTS_STICKY_STORE_URL": "mem://sticky/key",
				"OCTOSTS_STICKY_STORE_TTL": "1h",
			},
			wantErr: false,
		},
		{
		...
		{
			name: "Sticky store URL set with negative TTL rejected",
			envVars: map[string]string{
				"PORT":                     "8080",
				"GITHUB_APP_IDS":           "12345678",
				"OCTOSTS_STICKY_STORE_URL": "mem://sticky/key",
